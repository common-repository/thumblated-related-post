<?php
/*
Plugin Name: Thumblated Related Post
Plugin URI: http://www.devilslab.com/wp-thumblated-related-post
Description: This plugin shows related posts with thumbnails thats why it is named thumblated related post.It allows you to design your own layout using simple and easy interface.
Version: 1.0.5
Author: Shekhar Saxena
Author URI: http://www.devilslab.com

*/

/*	Copyright 2009  Devilslab.com 
...
{
    add_options_page('Thumblated Related Posts', 'Thumblated Related Posts', 'manage_options', 'thumblated-related-post/options.php');
}
...
function boposts_show()
{
    ...
    for ($i=0; $i<$c; $i++)
    {
        ...
        if ($image == '') $image = get_option('siteurl') . '/wp-content/plugins/thumblated-related-post/empty.gif';
    ...
    echo '<div align="right"><small><small><small><a href="http://www.devilslab.com/wp-thumblated-related-post" title="Thumblated Related Post">Thumblated Related Post</a></small></small></small></div>';
}
